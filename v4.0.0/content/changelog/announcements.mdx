...
<Update label="January 2026">
    ...
    Experience the new capabilities of Lightning V3.1 on our [platform](https://atoms.smallest.ai/dashboard/text-to-speech) or via the [API](/v4.0.0/content/api-references/lightning-v3.1).
</Update>
