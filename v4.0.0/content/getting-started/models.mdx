...
<CardGroup cols={2}>
  ...
  <Card title="Lightning V3.1" icon="square-3">
    A 44 kHz model delivering natural, expressive, and realistic speech. Supports voice cloning with ultra-low latency. Supports English and Hindi.
  </Card>
</CardGroup>
...
| **lightning-v3.1**  | 44 kHz model, natural expressive speech, ultra-low latency, supports voice cloning. | `English` <br/> `Hindi`                                                                                                                                                                                                                                                                          |
