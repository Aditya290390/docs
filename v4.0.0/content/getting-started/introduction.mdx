...
Waves is a speech AI platform by [Smallest AI](https://smallest.ai) that provides fast, accurate text-to-speech and speech-to-text APIs.
...
<Steps>
  <Step title="Get your API key">
    Sign up at the [platform](https://atoms.smallest.ai/dashboard?utm_source=documentation&utm_medium=getting-started) and create an API key from your dashboard.
  </Step>
