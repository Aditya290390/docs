...
This guide contains complete examples demonstrating real-time audio transcription in a variety of different usecases with different programming languages.
...
- [Streaming from Microphone](#streaming-from-microphone): Shows real-time transciption from microphone audio.
