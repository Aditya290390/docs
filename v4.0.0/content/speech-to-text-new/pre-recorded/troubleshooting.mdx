...
Go thorugh this guide to know about common bugs and issues that might occur with transcribing audio with Lighting STT.
...
- Capture the failing `request_id` and share it with [support@smallest.ai](mailto:support@smallest.ai).
